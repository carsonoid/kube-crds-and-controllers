...
import (
	v1alpha1 "github.com/carsonoid/kube-crds-and-controllers/controllers/crd-configured/pkg/client/clientset/versioned/typed/podlabeler/v1alpha1"
...
func (c *FakePodlabelerV1alpha1) PodLabelConfigs(namespace string) v1alpha1.PodLabelConfigInterface {
	return &FakePodLabelConfigs{c, namespace}
}

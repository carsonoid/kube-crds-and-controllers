...
import (
	...
	provisioner "github.com/carsonoid/kube-crds-and-controllers/controllers/workshop-provisioner/pkg/client/informers/externalversions/provisioner"
...
func (f *sharedInformerFactory) Provisioner() provisioner.Interface {
	return provisioner.New(f)
}
